...
public class ConnectBase {
    ...
    private final String DB_URL = "jdbc:sqlite:C:\\Users\\Admin\\Documents\\Elmira Studying\\Github_2019\\lesson_6\\db\\BaseAuthService.db";
    private final String DB_Driver = "org.sqlite.JDBC";
    //-----------------------------------------------------------------------------------------------------------------
    //объект ConnectBase выполняется 1 раз при запуске сервера, для получения соединения с бд - BaseAuthService.db(находится в папке db)
    ConnectBase() {
        try {
